                ...
                {currentStep === 0 ? (
                  <>
                    <label className={styles.fieldWide}>
                      ...
                      {selectedClientId > 0 ? (
                        <p className={styles.fieldHint} style={{ color: 'var(--success-text)' }}>
                  ...
                  <>
                    ...
                    {guidePreview ? (
                      <div className={styles.fieldWide} style={{
                        ...
                        <div><span style={{ fontSize: 12, color: 'var(--text-dim)' }}>Weekly installment</span><br /><strong>KES {formatMoney(guidePreview.installmentAmount)}</strong></div>
                        <div><span style={{ fontSize: 12, color: 'var(--text-dim)' }}>Total repayment</span><br /><strong>KES {formatMoney(guidePreview.scheduledRepaymentTotal)}</strong></div>
                        <div><span style={{ fontSize: 12, color: 'var(--text-dim)' }}>Total interest</span><br /><strong>KES {formatMoney(guidePreview.weeklyInterestAmount * watchedTermWeeks)}</strong></div>
                        <div><span style={{ fontSize: 12, color: 'var(--text-dim)' }}>Processing fee</span><br /><strong>KES {formatMoney(guidePreview.processingFee)}</strong></div>
                      </div>
                    ) : null}
                  </>
                ) : null}
