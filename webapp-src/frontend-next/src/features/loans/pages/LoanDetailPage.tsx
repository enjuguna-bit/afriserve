  ...
  return (
    <div className={styles.page}>
      ...
      {showFundingWorkspace ? (
        ...
        <section className={styles.spotlightSection} style={{ background: 'linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%)', borderColor: '#6ee7b7' }}>
          <div className={styles.spotlightContent} style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
            <div style={{ fontSize: '2.5rem', lineHeight: 1 }}>🎉</div>
            <div style={{ flex: 1, minWidth: 250 }}>
              <strong style={{ display: 'block', fontSize: '1.125rem', color: '#065f46', marginBottom: '0.25rem' }}>Loan Active & Disbursed</strong>
              <p style={{ margin: 0, color: '#047857' }}>This loan has been fully funded and the repayment schedule is active. The borrower's first installment is marked in the schedule.</p>
            </div>
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              <Link className={styles.primaryLink} to={`/loans/${loanId}/repay`} style={{ background: '#059669', color: '#fff' }}>Record Repayment</Link>
            </div>
          </div>
        </section>
      ) : null}
